...
function showResultBox() {    
    ...
    scoreText.textContent = `Your Score ${userScore} out of ${questions.length}`;//Your Score 0 out of 5.
    ...
    let progress = setInterval(() => {
        progresStartValue++;
        // console.log(progresStartValue);

        progressValue.textContent = `${progresStartValue}%`
        circularProgress.style.background = `conic-gradient(#1f4949 ${progresStartValue * 4.5}deg, rgba(255,255,255,1))`;
